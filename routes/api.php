...
Route::get('/social/auth/{provider}', [SocialPostAuthController::class, 'redirect'])->name('social.auth');
    Route::get('/social/auth/{provider}/callback', [SocialPostAuthController::class, 'callback'])->name('social.auth.callback');
